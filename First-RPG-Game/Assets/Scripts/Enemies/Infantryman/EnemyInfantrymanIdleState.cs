...
namespace Enemies.Infantryman
{
    ...
    //    }
    //}
    public class EnemyInfantrymanIdleState : EnemyInfantrymanGroundedState
    {
        public EnemyInfantrymanIdleState(Enemy enemyBase, EnemyStateMachine stateMachine, string animBoolName, EnemyInfantryman enemy) : base(enemyBase, stateMachine, animBoolName, enemy)
        {
        }
